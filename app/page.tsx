    ...
    <main style={styles.container}>
      <div style={styles.hero}>
        ...
        <p style={styles.subtitle}>
          ...
          successfully scaffolded with all your selected databases, components,
      ...
      <section id="features" style={styles.grid}>
        <div style={styles.card}>
          ...
          <p style={styles.cardText}>
            Built using modern Next.js 15 App Router with full Server Components
        ...
        <div style={styles.card}>
          ...
          <p style={styles.cardText}>
            Pre-configured middleware rules and pages for secure, lightning-fast
            session validation.
          </p>
        </div>
      ...
      <footer style={styles.footer}>
        ...
        <a
          href="https://github.com/Tanish02"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            color: "#71717a",
